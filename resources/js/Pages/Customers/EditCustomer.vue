        ...
        <div class="w-full">
          ...
          <form class="row" @submit.prevent="submit">
            <div class="mt-4 col-md-6">
              ...
              <TextInput id="name" type="text"  placeholder="Enter Name" class="form-control"  :value="form.name" v-model="form.name" autocomplete="name"/>
              <InputError class="mt-2" :message="errors.name" />
            </div>

            <div class="mt-4 col-md-6">
              <InputLabel for="email" value="Email" style="display: inline-block;" /><strong class="required-asterisk">* </strong>
              <TextInput id="email" type="email"  placeholder="Enter Email" class="form-control" :value="form.email" v-model="form.email" autocomplete="email" readonly/>
