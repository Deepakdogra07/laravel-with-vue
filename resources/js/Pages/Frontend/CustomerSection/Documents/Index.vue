...
async function submit_Document(){
    try {
        const response = await axios.post(route('submit_customer_doc'), form, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
        });
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6 col-12 checkbox_icon employ_padding">
                            <div class="d-flex gap-3">
                                ...
                                <p class="light-text">Employment contract listing your job title, salary and other information
                                </p>
                            </div>
                        </div>
                ...
                <div class="employment-first-form">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6 col-12 employ_padding">
                            <div class="d-flex gap-3">
                                <i class="fa-solid fa-circle-check green-text"></i>
                                <p class="light-text">You should submit evidence of any licences you hold that are related to your trade.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="inner_determine">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 employ_padding">
                                <ul class="job_ul">
                                    ...
                                    <li>1.4 Identify job requirements from specifications, sketches, job sheets or workinstructions
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 employ_padding">
                                <div class="d-flex gap-3">
                                    <i class="fa-solid fa-circle-check green-text"></i>
                                    <p class="light-text">et up and adjust measuring equipment to required accuracy and specifications
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-6 col-12 employ_padding">
            ...
            <div class="container">
                <div class="employment-first-form intro_steps intro_top">
                    <div class="intro_inner">
                        <h2>Introduction</h2>
                        <p class="light-text">When you provide evidence of your workplace skills for the Stage 1 Documentary Evidence Assessment, you must also provide Video and Photo evidence.</p>
                        <p class="light-text">This Guideline provides instructions about what types of skills to capture in your video/photo evidence and how to record them.</p>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-12 employ_padding">
                            <p class="light-text">As you prepare your dish, film the following five (5) videos. Note the skills you should demonstrate in each video
                            </p>
                        ...
                        <div class="prepare_kitchen p-0">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Visually checking work areas and equipment are hygienic and safe to use
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Selecting appropriate equipment based on recipe requirements
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Assembling equipment according to manufacturer's instructions and checking it is in proper working order
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 employ_padding">
                        ...
                        <div class="employment-first-form intro_steps employ_padding ">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Identifying and selecting ingredients based on recipe requirements
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 employ_padding">
                                ...
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Sorting ingredients in the order they will be used during food production
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Using equipment (e.g. scales) to accurately measure and weigh ingredients
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Cutting ingredients to the required size and shape, ensuring consistency and minimising waste.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="employment-first-form intro_steps employ_padding">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Using appropriate cooking methods to prepare the dish and relevant sides/sauces according to recipe requirements
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Handling and operating food preparation equipment safely, according to manufacturer specifications
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Reviewing the dish and making quality adjustments (e.g. taste and texture) where necessary
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="employment-first-form intro_steps employ_padding">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Using appropriate dishware and garnishes to enhance the visual appeal of the dish</p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Arranging the dish in a visually pleasing way, ensuring the plate is free of drips</p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                        ...
                        <div class="employment-first-form intro_steps employ_padding">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Cleaning and sanitising the work area (including benches, appliances and equipment) </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                ...
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        <i class="fa-solid fa-circle-check green-text"></i>
                                        <p class="light-text">Labelling food containers with description and date of preparation
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="login-bg-wrapper steps_form document-first-form step-form-6 application_guide" v-if="div_numbers == 'step-form-6'">
            <div class="container width_content">
                <div class="employment-first-form instructions">
                    ...
                    <p class="light-text">In addition to submitting videos, you must at least twenty (20) photos demonstrating your skills as a commercial chef.</p>
                    ...
                    <div class="submit_dishes">
                        ...
                        <h5 class="bg_grey bg_border">In addition to the above, you must submit at least one (1) photo or scan for each of the following workplace documents you have created.</h5>
                        <ul class="green_bg">
                        ...
                        <ul class="green_bg">
                            ...
                            <li class="last_border">14. One (1) recipe you have developed to meet special dietary requirements
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="employment-first-form">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="d-flex gap-3">
                                    <p class="light-text">include a description of what you are doing and why (you can add a description for each photo when you upload it)
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="file_size employ_padding">
                            ...
                            <p class="light-text">Photo files must be named 'Surname_First Name_Photo_number'. For example: 'Smith_Peter_Photo_1'</p>
                            <p class="light-text">Upload your photos via the VETASSESS online portal when submitting your application.</p>
                        </div>
                ...
                <div class="employment-first-form steps_55">
                    ...
                    <div class="row">
                        ...
                        <div class="documents_bottom p-0">
                            <p class="light-text">At the end of this document we have provided a checklist that will help you ensure you have all the evidence we need.</p>
                        </div>
    
                        <div class="col-12 p-0">
                            <div class="employ_note">
                                <h2>IMPORTANT:</h2>
                                <p>All employment and training documents must be high quality colour scans of the originals. If your documents are not in English, you must submit both the original documents and the English translations made by a registered translation
                                    service.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="documents_bottom p-0">
                            <p class="light-text">An assessor will review your documents to ensure that they meet the employment and training requirements for your nominated occupation and indicate that you have the necessary skills, knowledge and experience in your trade.</p>
    
                            <p class="light-text">The skills and knowledge required for your trade in Australia are found in a Training Package for a qualification relevant to your nominated occupation. They are called the units of competency.</p>
    
                            <p class="light-text">To see all the units of competency for a qualification relevant to your occupation, download the Fact Sheet for your trade from: <a href="#">https://www.vetassess.
