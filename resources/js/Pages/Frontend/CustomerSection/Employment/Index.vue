...
<template>
    ...
    <div class="login-bg-wrapper steps_form employment-first-form step-form-1 d-none">
        <div class="container">
            ...
            <div class="employment-first-form">
                <p class="light-text">You must provide official employment evidence to demonstrate that you meet the minimum
                    employment experience requirements for your nominated occupation.Each period of employment submitted for
                ...
                <div class="row mt-4">
                    <div class="col-md-6 col-12">
                        <div class="d-flex gap-3">
                            ...
                            <p class="light-text">your exact employment period (start and finish dates, including day and
                                month)
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="d-flex gap-3">
                            <i class="fa-solid fa-circle-check green-text"></i>
                            <p class="light-text">the name and address of the business on official business letterhead</p>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="d-flex gap-3">
                            <i class="fa-solid fa-circle-check green-text"></i>
                            <p class="light-text"> the name, position, contact details (business phone number and email
                                address), date and signature of the person authorised to make the employer statement and the
                                length of time they supervised your work. This person, known as your ‘referee’, must be your
    ...
    <!-------step two----------->
    <div class="login-bg-wrapper steps_form employment-first-form step-form-2 d-none">
        <div class="container">
            <!-- 1 -->
            <div class="employment-first-form">
    ...
    <!-------step three----------->
    <div class="login-bg-wrapper steps_form employment-first-form step-form-3 d-none">
        <div class="container">
            <!-- 1 -->
            <div class="employment-first-form">
     ...
     <!-------step four----------->
     <div class="login-bg-wrapper steps_form employment-first-form step-form-4 d-none">
        <div class="container">
            <!-- 1 -->
            <div class="employment-first-form">
                <h2>4 Formal Training Evidence</h2>
                <p class="light-text">If you have completed formal training related to your trade, you must submit official evidence including:</p>
                <div class="row mt-4">
                    <div class="col-md-6 col-12">
                        <div class="d-flex gap-3">
                            <i class="fa-solid fa-circle-check green-text"></i>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="d-flex gap-3">
                            <i class="fa-solid fa-circle-check green-text"></i>
                            <p class="light-text">apprenticeship documents, such as the contract of apprenticeship, journal or any other relevant document from the employer, governing body or training institution relating to the apprenticeship (if applicable). </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-12 margin_minus">
                        <div class="d-flex gap-3">
                            <i class="fa-solid fa-circle-check green-text"></i>
                            <p class="light-text">a full academic transcript or other documents that include the start and end date of training and details of the program of study</p>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="file-inputs mt-3 relative">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="d-flex gap-3">
                            <i class="fa-solid fa-circle-check green-text"></i>
                            <p class="light-text">qualifications where most of the training was not directly related to your nominated occupation</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="d-flex gap-3">
                            <i class="fa-solid fa-circle-check green-text"></i>
                            <p class="light-text"> training that lacks official recognition by the relevant educational authorities in the country where it was undertaken.</p>
                        </div>
                    </div>
