          ...
          <form @submit.prevent="submit">
            <div class="row">
              <div class="mt-4 col-md-6">
                ...
                <TextInput id="name" type="text"  placeholder="Enter Customer Name" class="form-control" v-model="form.name" autocomplete="name"/>
                <InputError class="mt-2" :message="form.errors.name" />
              </div>

              <div class="mt-4 col-md-6">
                <InputLabel for="email" value="Email" style="display: inline-block;" /><strong class="required-asterisk">* </strong>
                <TextInput id="email" type="email"  placeholder="Enter Email" class="form-control" v-model="form.email" autocomplete="email"/>
                <InputError class="mt-2" :message="form.errors.email" />
              </div>

              <div class="mt-4 col-md-6">
                <InputLabel for="password" value="Password" style="display: inline-block;" /><strong class="required-asterisk">* </strong>
                <TextInput id="password" type="password" placeholder="Enter Password" class="form-control" v-model="form.password" />
              ...
              <div class="mt-4 col-md-6">
                  ...
                  <TextInput id="password_confirmation" type="password" placeholder="Enter Confirm Password" class="form-control"
              ...
              <div class="mt-4 col-md-6">
                  ...
                  <TextInput id="phone" type="text" placeholder="Enter Phone Number" class="form-control" v-model="form.phone" autocomplete="phone" />
