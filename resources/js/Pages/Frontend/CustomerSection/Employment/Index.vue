        ...
        <div class="login-bg-wrapper steps_form employment-first-form step-form-1 employment_next"
            ...
            <div class="container width_content">
                ...
                <div class="employment-first-form">
                    <p class="light-text  mobile_padding">You must provide official employment evidence to demonstrate
                        that you
                        meet the
                            ...
                            <div class="d-flex align-items-start all_image_close">
                                ...
                                <p class="doc_txt" style="width:400px" v-else>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor"
                                        class="doc_img bi bi-file-earmark-text" viewBox="0 0 16 16">
                                        <path
                                            d="M5.5 7a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1zM5 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5" />
                                        <path
                                            d="M9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.5zm0 1v2A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z" />
                                    </svg>
                                <div class="txt_over"><b>{{ form.employer_statement.name }}</b>
                                    <p>file uploaded!</p>
                                </div>
                                </p>
                            </div>
                                ...
                                <div class="d-flex align-items-start all_image_close">
                                    ...
                                    <p class="doc_txt" style="width:400px" v-else>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80"
                                            fill="currentColor" class="doc_img bi bi-file-earmark-text"
                                            viewBox="0 0 16 16">
                                            <path
                                                d="M5.5 7a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1zM5 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5" />
                                            <path
