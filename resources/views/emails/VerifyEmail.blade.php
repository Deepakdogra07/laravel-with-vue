...
<body style="font-family: Helvetica, Arial, sans-serif; margin: 0px; padding: 0px;">
    <div  style="background-color: #09332B; display: flex; padding: 10px 0; justify-content: center;">
        <!-- <img src="{{ url('/images/web-logo.png') }}" alt="Company" style="display: block;width: 150px; margin: 0 auto;">  -->
        <img src="{{ url('https://unstoppable.dev.visionvivante.com/images/web-logo.png') }}" alt="Company" style="display: block;width: 150px; margin: 0 auto;"> 
    </div>
