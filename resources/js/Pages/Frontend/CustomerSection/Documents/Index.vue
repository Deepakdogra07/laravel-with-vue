...
<template>
    ...
    <form @submit.prevent="submit_form()">
        <!------step one----->
        <div class="login-bg-wrapper steps_form document-first-form step-form-1 application_guide"
                        ...
                        <div class="col-12 p-0">
                            <div v-if="document.employment_evidence" class="mt-3 relative upload_file">
                                <div class="d-flex align-items-start all_image_close">
                                    ...
                                    <img v-if="form.employment_evidence.type.startsWith('image/')"
                                        :src="document.employment_evidence" alt="" srcset="" width="250px" />
                                    <p v-else><b>{{ form.employment_evidence.name }}</b> file uploaded!</p>
                                </div>
                            ...
                            <div v-else class="file-inputs mt-3 relative">
                                <div class="dotted-bg">
                                    ...
                                    <input class="upload" type="file" id="banner"
                                        @change="show_document('employment_evidence', $event, 'doc', 20)">
        ...
        <!------step two----->
        <div class="login-bg-wrapper steps_form document-first-form step-form-2 application_guide"
                        ...
                        <div class="col-12 employ_padding">
                            ...
                            <div v-else class="file-inputs mt-3 relative">
                                <div class="dotted-bg">
                                    ...
                                    <p class="file-type">Max size 20MB</p>
                                    <input class="upload" type="file" id="banner"
                                        @change="show_document('licences', $event, 'doc', 20)">
        ...
        <!------step three----->
        <div class="login-bg-wrapper steps_form document-first-form step-form-3 application_guide"
            v-if="div_numbers == 'step-form-3'">
            <div class="container width_content">
                <div class="employment-first-form">
                    <h2>3. Photographs and videos</h2>
                    <p class="light-text mt-3">Photos and videos of you performing work tasks maybe provided if they:
                    </p>
                    <div class="row mt-2">
                        <div class="col-md-6 col-12 employ_padding">
                            <div class="d-flex gap-3">
            ...
            <Section class="determine_job step-form-3 mt-4">
                <div class="container width_content">
                    <div class="inner_determine">
                        <h6>For example, below is a unit of competency taken from the qualification ‘MEM31519
                            Certificate III in Engineering – Toolmaking Trade’.</h6>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 employ_padding">
                                <ul class="job_ul">
                                    ...
                                    <li>1.3 Use appropriate personal protective equipment (PPE) in accordance with SOPs
                                    </li>
                                </ul>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 employ_padding">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 employ_padding">
                                <ul class="job_ul">
                                    ...
                                    <li>2.3 Use correct and appropriate measuring techniques for the measurement task
                                    </li>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 employ_padding">
                                <ul class="job_ul">
                                    ...
                                    <li>2.4 Take measurements to the finest graduation of instrument in an accurate
                                        manner
                                    </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 employ_padding">
                                <ul class="job_ul">
                                    <li>3.2 Adjust and maintain measuring equipment to required accuracy using
                                        appropriate techniques according to manufacturer’s specifications or SOPs</li>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12 employ_padding">
                                <div class="d-flex gap-3">
                                    <i class="fa-solid fa-circle-check green-text"></i>
                                    <p class="light-text">identify the requirements of the job from drawings or
                                        instructions
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12 employ_padding">
                                <div class="d-flex gap-3">
                                    <i class="fa-solid fa-circle-check green-text"></i>
                                    <p class="light-text"> use appropriate personal protective equipment and follow
        ...
        <!------step five----->
        <div class="login-bg-wrapper steps_form document-first-form step-form-5 application_guide"
            v-if="div_numbers == 'step-form-5'">
            <div class="container">
                <div class="employment-first-form intro_steps intro_top">
                    <div class="intro_inner">
                        ...
                        <p class="light-text">This Guideline provides instructions about what types of skills to capture
                            in your video/photo evidence and how to record them.</p>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-12 employ_padding">
                            <p class="light-text">As you prepare your dish, film the following five (5) videos. Note the
                                skills you should demonstrate in each video
                            </p>
                        ...
                        <div class="col-12 employ_padding">
                            <div v-if="document.kitchen_area" class="mt-3 relative upload_file">
                                <div class="d-flex align-items-start all_image_close">
                                    ...
                                    <p class="btn btn-sm btn-danger justify-content-end close_mark"
                                        style="float:right; z-index:1;" @click="removeImage('kitchen_area')"><i
                            ...
                            <div v-else class="file-inputs mt-3 relative">
                                <div class="dotted-bg">
                                    ...
                                    <input class="upload" type="file" id="banner"
                                        @change="show_document('kitchen_area', $event, 'video', 100)" accept="video/*">
                                </div>
                            </div>
                        ...
                        <div class="col-12 employ_padding">
                            ...
                            <div v-else class="file-inputs mt-3 relative">
                                <div class="dotted-bg">
                                    ...
                                    <p class="file-type">Max Size 100mb</p>
                                    <input class="upload" type="file" id="banner"
                                        @change="show_document('ingredients', $event, 'video', 100)" accept="video/*">
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 col-12 employ_padding">
                                    <div class="d-flex gap-3">
                                        ...
                                        <p class="light-text">Using appropriate cooking methods to prepare the dish and
                                            relevant sides/sauces according to recipe requirements
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 employ_padding">
                        ...
                        <div class="col-12 employ_padding">
                            ...
                            <div v-else class="file-inputs mt-3 relative">
                                <div class="dotted-bg">
                                    ...
                                    <p class="file-type">Max Size 100mb</p>
                                    <input class="upload" type="file" id="banner"
                                        @change="show_document('cooking_tech', $event, 'video', 100)" accept="video/*">
                                </div>
                            </div>
                        ...
                        <div class="col-12 employ_padding">
                            ...
                            <div v-else class="file-inputs mt-3 relative">
                                <div class="dotted-bg">
                                    ...
                                    <p class="file-type">Max Size 100mb</p>
                                    <input class="upload" type="file" id="banner"
                                        @change="show_document('dish', $event, 'video', 100)" accept="video/*">
                                </div>
                            </div>
                        ...
                        <div class="col-12 employ_padding">
                            ...
                            <div v-else class="file-inputs mt-3 relative">
                                <div class="dotted-bg">
                                    ...
                                    <p class="file-type">Max Size 100mb</p>
                                    <input class="upload" type="file" id="banner"
                                        @change="show_document('clean_up', $event, 'video', 100)" accept="video/*">
                                </div>
                            </div>
        ...
        <!------step six----->
        <div class="login-bg-wrapper steps_form document-first-form step-form-6 application_guide"
            v-if="div_numbers == 'step-form-6'">
            <div class="container width_content">
                <div class="employment-first-form instructions">
                    ...
                    <div class="submit_dishes">
                        ...
                        <h5 class="bg_grey bg_border">In addition to the above, you must submit at least one (1) photo
                            or scan for each of the following workplace documents you have created.</h5>
                        <ul class="green_bg">
                        ...
                        <div class="col-12 p-0">
                            ...
                            <div v-else class="file-inputs mt-3 relative">
                                <div class="dotted-bg">
                                    ...
                                    <input class="upload" type="file" id="banner"
                                        @change="show_document('evidence_image', $event, 'image', 5)">
                                </div>
                            </div>
        ...
        <!------step seven----->
        <div class="login-bg-wrapper steps_form document-first-form step-form-7 application_guide"
            v-if="div_numbers == 'step-form-7'">
            <div class="container width_content">
                        ...
                        <div class="col-12 p-0">
                            <div v-if="document.resume" class="mt-3 relative upload_file">
                                <div class="d-flex align-items-start all_image_close">
                                    ...
                                    <img v-if="form.resume.type.startsWith('image/')" :src="document.resume" alt=""
                                        srcset="" width="250px" />
                                    <p v-else><b>{{ form.resume.name }}</b> file uploaded!</p>
                                </div>
                            ...
                            <div v-else class="file-inputs mt-3 relative">
                                <div class="dotted-bg">
                                    ...
                                    <p class="file-type">Max size 20MB</p>
                                    <input class="upload" type="file" id="banner"
                                        @change="show_document('resume', $event, 'doc', 20)">
                                </div>
                            </div>
                        ...
                        <div class="col-12 p-0">
                            <div class="employ_note">
                                ...
                                <p>All employment and training documents must be high quality colour scans of the
                                    ...
                                    documents and the English translations made by a registered translation
                                    service.
                                </p>
                            </div>
                        </div>
