                        ...
                        <form @submit.prevent="submit" enctype="multipart/form-data">
                            <div class="row add-job-form-section job_posting_page">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="">
                                        <span class="label text-label">Job Title <span style="color:red">
                                                *</span></span>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="eye-icon-div skills_input">
                                            <multiselect v-model="form.skills_id" :options="props.skills"
                                                ...
                                                :preserve-search="true" placeholder="Select Skills" label="name"
                                                track-by="name">
                                            </multiselect>
                                    ...
                                    <div class="mt-4 arrow_label">
                                        ...
                                        <div class="eye-icon-div language_input mt-2">
                                            <multiselect v-model="form.language_id" :options="props.languages"
                                                :multiple="true" :close-on-select="false" :clear-on-select="false"
                                                :preserve-search="true" placeholder="Select Languages" label="name"
                                                track-by="name">
                                            </multiselect>
                                        </div>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="eye-icon-div">
                                            <TextInput id="city" type="text" v-model="form.city"
                                                placeholder="Enter City" class="form-control mt-2  " />
                                        </div>
                                    ...
                                    <div class="mt-4 arrow_label">
                                        ...
                                        <option v-for="(position, index) in industries" :key="index"
                                            ...
                                            <multiselect v-model="form.industry_id" :options="props.industries"
                                                :multiple="true" :close-on-select="false" :clear-on-select="false"
                                                :preserve-search="true" placeholder="Select Industries" label="name"
                                                track-by="name">
                                            </multiselect>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="mt-4   ">
                                        <span class="label text-label">Job Posting Summary<span style="color:red">
                                                *</span></span>
                                        <div class="eye-icon-div">
                                            <textarea id="job_summary" rows="5" type="text"
                                                v-model="form.posting_summary" placeholder="Enter job posting summary"
                                    ...
                                    <div class="mt-4 spacing_btm new-job-description">
                                        ...
                                        <div class="eye-icon-div mt-2">
                                            <QuillEditor contentType="html" toolbar="essential"
                                                v-model:content="form.job_description"
