<template>
    ...
    <aside class="z-20 hidden px-3 md:block flex-shrink-0 side-navbar" style="height: 100vh; width: 75% !important;">
        <div class="py-4 text-black-500 main-links-nav">
            ...
            <ul class="mt-6 pl-0">
                ...
                <li class="relative px-6 py-3" v-if="$page.props.auth.user.user_type == 1">
                    <NavLink :href="route('edit-home-page')" :active="route().current('edit-home-page')">
                        <template #icon>
