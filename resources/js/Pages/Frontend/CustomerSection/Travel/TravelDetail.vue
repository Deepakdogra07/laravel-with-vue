...
//     alert(newValue);
//     console.log(`new town_id: ${newValue} old town_id: ${oldValue}`);
...
const calender_input = ref({
    discipline: '',
});
function handleChange(type) {
    if (type == "discipline") {
        calender_input.value.discipline = 'alka';
    }
}
                ...
                <div class="travel-detail mb-5">
                    <div class="inner_travel_wrapper">
                        ...
                        <div class="flex items-center"><label class="flex items-center mb-2">
                                <TextInput type="radio" class="remember-me-check" name="remember1" value="Tourism"
                                    v-model="form.purpose_of_stay" :checked="form.purpose_of_stay == 'Tourism'" />
                                <span class="ml-2 cursor-pointer remember-me">Tourism</span>
                            </label></div>
                        <div class="flex items-center"><label class="flex items-center mb-2">
                                <TextInput :checked="form.purpose_of_stay == 'Business'" type="radio"
                                    class="remember-me-check" name="remember1" value="Business"
                                    v-model="form.purpose_of_stay" />
                                <span class="ml-2 cursor-pointer remember-me">Business</span>
                            </label></div>
                        <div class="flex items-center"><label class="flex items-center mb-2">
                                <TextInput :checked="form.purpose_of_stay == 'Transit'" type="radio"
                                    class="remember-me-check" name="remember1" value="Transit"
                                    v-model="form.purpose_of_stay" />
                ...
                <div class="row mt-5 travel_row">
                    <div class="col-md-6 col-12 p-0">
                        <div class="travel-detail">
                            <h4 class="mb-3">Traditional visa <span data-v-ef3b84b0="" style="color: red;"> *</span>
                            </h4>
                            <div class="flex items-center"><label class="flex items-center mb-2">
                                    <TextInput type="radio" class="remember-me-check" name="remember"
                                        value="skilled_visa(individual)"
                                        :checked="form.type_of_visa == 'skilled_visa(individual)'"
                                        v-model="form.type_of_visa" />
                                    <span class="ml-2 cursor-pointer remember-me">Skilled Visa (individual)</span>
                                </label></div>
                            <div class="flex items-center"><label class="flex items-center mb-2">
                                    <TextInput type="radio" :checked="form.type_of_visa == 'skilled_visa(consultation)'"
                                        class="remember-me-check" name="remember" value="skilled_visa(consultation)"
                                        v-model="form.type_of_visa" />
                                    <span class="ml-2 cursor-pointer remember-me">Skilled Visa (consultation)</span>
                                </label></div>
                            <div class="flex items-center"><label class="flex items-center mb-2">
                                    <TextInput type="radio" class="remember-me-check" name="remember"
                                        value="relative_option_visa"
                                        :checked="form.type_of_visa == 'relative_option_visa'"
                                        v-model="form.type_of_visa" />
                                    <span class="ml-2 cursor-pointer remember-me">Relative Option Visa</span>
                                </label></div>
                            <div class="flex items-center"><label class="flex items-center mb-2">
                                    <TextInput type="radio" class="remember-me-check" name="remember"
                                        value="partner_visa(consultation)"
                                        :checked="form.type_of_visa == 'partner_visa(consultation)'"
                                        v-model="form.type_of_visa" />
                                    <span class="ml-2 cursor-pointer remember-me">Partner Visa (consultation)</span>
                                </label></div>
                            <div class="flex items-center"><label class="flex items-center mb-2">
                                    <TextInput type="radio" class="remember-me-check" name="remember"
                                        value="investor_visa(consultation)"
                                        :checked="form.type_of_visa == 'investor_visa(consultation)'"
                                        v-model="form.type_of_visa" />
                            ...
                            <div class="flex items-center"><label class="flex items-center mb-2">
                                    <TextInput type="radio" class="remember-me-check" name="remember"
                                        ...
                                        :checked="form.type_of_visa == 'other(consultation)'"
                                        v-model="form.type_of_visa" />
                    ...
                    <div class="col-md-6 col-12 travel-form-main p-0">
                        <div class="col-md-12 natoinality_row row">
                            <div class="col-md-6 col-12 calender_input input_margin">
                                <span class="label text-label">Planned date of travel <span data-v-ef3b84b0=""
                                        style="color: red;"> *</span></span>
                                <!-- <TextInput id="email" type="date" class="form-control mt-2" v-model="form.date_of_travel"/> -->
                                <VueDatePicker v-model="form.date_of_travel" placeholder="Select Date of travel"
                                    class="form-control mt-2  test_new" :format="format" :min-date="today"
                                    prevent-min-max-navigation :type="'date'" />
                            ...
                            <div class="col-md-6 col-12 input_margin">
                                ...
                                <span class="label text-label">Passenger nationality <span data-v-ef3b84b0=""
                                        style="color: red;"> *</span></span>

                                <select class="form-select select_option mt-2" :class="select_class"
                                    @change="handleCountryInput('nationality')" v-model="form.passenger_nationality">
                        ...
                        <div class="row natoinality_row">
                            <div class="col-md-6 col-12 mt-4 spacinf_rigght input_margin">
                                <!-- <InputLabel class="text-blue" for="email" value="Email" /> -->
                                <span class="label text-label">Country To Immigrate <span data-v-ef3b84b0=""
                                        style="color: red;"> *</span></span>

                                <select class="form-select select_option mt-2" :class="migrate"
                                    @change="handleCountryInput('migrate')" v-model="form.migrate_country">
                                    <option selected :value="null">----</option>
                                    <option v-for="country in countries" :value="country.name">{{ country.name }}
                                    </option>
                                </select>
                            ...
                            <div class="col-md-6 col-12 mt-4 input_margin">
                                <!-- <InputLabel class="text-blue" for="email" value="Email" /> -->
                                <span class="label text-label">Port of arrival <span data-v-ef3b84b0=""
                                        style="color: red;"> *</span></span>

                                <TextInput type="text" placeholder="Enter Port of arrival" class="form-control mt-2"
                                    v-model="form.port_of_arrival" />
