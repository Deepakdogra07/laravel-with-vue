...
onMounted( () => {
    // console.log('loanData',props.loanData);
...
<template>
 ...
 >
                        ...
                        <div v-if="modal === 3" class="flex items-center justify-center h-full">
                            <div class="bg-white rounded-lg p-4 w-100">
                                <h2 class="text-2xl font-bold mb-4">Change Status</h2>
                                <ChangeLoanStatus :pageviewValue="pageviewValue"  :key="key" :loanData="loanData" :loanId="loanId" :initialStatus="initialStatus" @close="close" :userType="userType" />
                            </div>
                        </div>
