    ...
    <div style=" background-color: rgb(255, 255, 255);">
        <div style="color: rgb(0, 0, 0); text-align: left;">
            ...
            <div style="padding: 20px;">
                <h3 style="margin: 1rem 0">Olá <strong style="font-size: 130%">{{
                        ucfirst($username) }}</strong></h3>
                <br>
                <h4 style="color: #009919;">
                    <span style="font-size: 30px;">Parabéns</span> para você. Seu empréstimo foi aprovado
                </h4>
