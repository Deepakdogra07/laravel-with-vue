                    ...
                    <div class="employment-first-form intro_steps">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 col-12">
                                <div class="d-flex gap-3">
                                    <i class="fa-solid fa-circle-check green-text"></i>
                                    <p class="light-text">Using appropriate cooking methods to prepare the dish and relevant
sides/sauces according to recipe requirements
                            ...
                            <div class="col-md-6 col-12">
                                <div class="d-flex gap-3">
                                    <i class="fa-solid fa-circle-check green-text"></i>
                                    <p class="light-text">Handling and operating food preparation equipment safely, according to
    ...
    <div class="login-bg-wrapper steps_form document-first-form step-form-5 ">
        <div class="container">
            <div class="employment-first-form instructions">
                ...
                <p class="light-text">Submit at least one (1) photo of you preparing each of the following dishes.</p>

                <div class="submit_dishes">
                    <h5 class="bg_grey">Submit at least one (1) photo of you preparing each of the following dishes.</h5>
                    <ul class="green_bg">
                    ...
                    <h5 class="bg_grey bg_border">In addition to the above, you must submit at least one (1) photo or scan for each of the following
                    ...
                    <ul class="green_bg">
                        ...
                        <li class="last_border">14. One (1) recipe you have developed to meet special dietary requirements</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="employ_note">
                            <h2>IMPORTANT:</h2>
                            <p>All employment and training documents must be high quality colour scans of the originals. If your documents are not in English, you must submit both the original documents and the English translations made by a registered translation service.</p>
                        </div>
                    </div>
                    ...
                    <div class="documents_bottom">
                        ...
                        <p class="light-text">To see all the units of competency for a qualification relevant to your occupation, download the Fact Sheet for your trade from: <a href="#">https://www.vetassess. com.au/skills-assessment-for-migration/tradeoccupations/guides-and-factsheets.</a></p>
